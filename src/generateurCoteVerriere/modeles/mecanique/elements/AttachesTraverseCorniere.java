...
public class AttachesTraverseCorniere extends ElementGenerique {
	...
	private final double nbCotesAGauche = conf.get("nbAttachesIntermediaires") + 3;
	...
	public AttachesTraverseCorniere(HashMap<String, Double> conf){
		super(conf);
	}
	...
	private void draw(MyCustomSvgEnhanced g){		
	    ...
	    g.drawLine(this.abscisseAxeTraverse + conf.get("largeurTraverseCorniere") / 2, this.ordonneeHautTraverse, this.abscisseAxeTraverse + conf.get("largeurTraverseCorniere") / 2, this.ordonneeBasTraverse);
	    g.drawLine(this.abscisseAxeTraverse - conf.get("largeurTraverseCorniere") / 2, this.ordonneeHautTraverse, this.abscisseAxeTraverse + conf.get("largeurTraverseCorniere") / 2, this.ordonneeHautTraverse);
	    g.drawLine(this.abscisseAxeTraverse - conf.get("largeurTraverseCorniere") / 2, this.ordonneeBasTraverse, this.abscisseAxeTraverse + conf.get("largeurTraverseCorniere") / 2, this.ordonneeBasTraverse);
