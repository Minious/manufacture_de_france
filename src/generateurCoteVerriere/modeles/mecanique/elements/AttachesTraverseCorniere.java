...
public class AttachesTraverseCorniere extends ElementGenerique {
	...
	private final double nbCotesAGauche = ((Conf) conf).nbAttachesIntermediaires + 3;
	...
	private void draw(MyCustomSvgEnhanced g){		
	    ...
	    g.drawLine(this.abscisseAxeTraverse + ((Conf) conf).largeurTraverseCorniere / 2, this.ordonneeHautTraverse, this.abscisseAxeTraverse + ((Conf) conf).largeurTraverseCorniere / 2, this.ordonneeBasTraverse);
	    g.drawLine(this.abscisseAxeTraverse - ((Conf) conf).largeurTraverseCorniere / 2, this.ordonneeHautTraverse, this.abscisseAxeTraverse + ((Conf) conf).largeurTraverseCorniere / 2, this.ordonneeHautTraverse);
	    g.drawLine(this.abscisseAxeTraverse - ((Conf) conf).largeurTraverseCorniere / 2, this.ordonneeBasTraverse, this.abscisseAxeTraverse + ((Conf) conf).largeurTraverseCorniere / 2, this.ordonneeBasTraverse);
		...
		int nbCotes = ((Conf) conf).nbAttachesIntermediaires + 3;
		for(int i = 1 ; i <= nbCotes ; i++){
			if(i == 1 || i == nbCotes)
				pTemp.move(0, - ((Conf) conf).ecartEntreExtremiteEtPremierTrouAttachesTraverseCorniere);
			else
				pTemp.move(0, - ((Conf) conf).entreAxeAttachesTraverseCorniere);
