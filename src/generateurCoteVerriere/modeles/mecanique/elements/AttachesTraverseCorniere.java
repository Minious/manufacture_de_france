...
public class AttachesTraverseCorniere extends ElementGenerique {
	...
	private final double nbCotesAGauche = conf.nbAttachesIntermediaires + 3;
	...
	public AttachesTraverseCorniere(Conf conf){
		super(conf);
	}
	...
	private void draw(MyCustomSvgEnhanced g){		
	    ...
	    g.drawLine(this.abscisseAxeTraverse + conf.largeurTraverseCorniere / 2, this.ordonneeHautTraverse, this.abscisseAxeTraverse + conf.largeurTraverseCorniere / 2, this.ordonneeBasTraverse);
	    g.drawLine(this.abscisseAxeTraverse - conf.largeurTraverseCorniere / 2, this.ordonneeHautTraverse, this.abscisseAxeTraverse + conf.largeurTraverseCorniere / 2, this.ordonneeHautTraverse);
	    g.drawLine(this.abscisseAxeTraverse - conf.largeurTraverseCorniere / 2, this.ordonneeBasTraverse, this.abscisseAxeTraverse + conf.largeurTraverseCorniere / 2, this.ordonneeBasTraverse);
		...
		int nbCotes = conf.nbAttachesIntermediaires + 3;
		for(int i = 1 ; i <= nbCotes ; i++){
			if(i == 1 || i == nbCotes)
				pTemp.move(0, - conf.ecartEntreExtremiteEtPremierTrouAttachesTraverseCorniere);
			else
				pTemp.move(0, - conf.entreAxeAttachesTraverseCorniere);
